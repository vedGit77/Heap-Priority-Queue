...
// a. If the size of max heap is greater than the size of min-heap AND the element is less than the previous median, then pop the top element from max heap and insert into min-heap and insert the new element to max heap 
//    else insert the new element to min-heap. 
//    Calculate the new median as the average of top of elements of both max and min heap.
// b. If the size of max heap is less than the size of min-heap and the element is greater than the previous median, then pop the top element from min-heap and insert into the max heap and insert the new element to min heap 
